...
API_ID = int(environ.get('API_ID', '24415394'))
API_HASH = environ.get('API_HASH', '5aca388cfe4ae0bc754dee1c3da4fd5e')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002255052414'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '900984832').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002149540076').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://abhinavnarendra19:<HMxGUv1hSQMrMGFo>@cluster0.nkfo6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://abhinavnarendra20:<zNW143n1G3tlidE4>@cluster0.6xa25.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
